<!--div class="p-6 bg-white border-b border-gray-200 lg:p-8">
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Welcome to your Jetstream application!sssss
    </h1>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="submenu  {{ (request()->is('student/edit/*')) ? 'active' : '' }} {{ (request()->is('student/profile/*')) ? 'active' : '' }}">
                    <a href="#"><i class="fas fa-graduation-cap"></i>
                        <span> Items</span>
                        <span class="menu-arrow"></span>
                    </a>
                    <ul>
                        <li><a href="#"  class="{{set_active(['item/list'])}}">Item List</a></li>
                        <li><a href="#" class="{{set_active(['item/add/page'])}}">Item Add</a></li>
