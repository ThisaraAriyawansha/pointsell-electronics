@include('layouts.header')
    <div class="flex flex-col flex-grow">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <p class="text-sm font-medium text-gray-700 ms-1 md:ms-2">Add Expense Category</p>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <form method="POST" action="{{ route('addExpenseCategory') }}" enctype="multipart/form-data">
        @csrf
            <div class="p-6">
