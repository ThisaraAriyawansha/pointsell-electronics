            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <p class="text-sm font-medium text-gray-700 ms-1 md:ms-2">Update Expense</p>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="flex flex-col flex-grow h-full p-6 border-2 rounded-lg">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input datepicker id="exp_date" type="text" name = "expense_date"
                                value="{{ $expenses->expense_date->format('Y-m-d') }}"
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3">
                    ...
                    <div class="md:col-span-2">
                        <label for="price" class="block mb-2 text-sm font-medium text-black ">Expence
                            Category</label>
                        <select type="tel" id="price" name = "exp_cat"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            placeholder="Enter price" required>
                            <option value="0">Select an expense Category</option>
                            @foreach ($categorie as $categorie)
                                <option value="{{ $categorie->id }}"
                                    {{ $categorie->id === $expenses->expense_categories_id ? 'selected' : '' }}>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3">
                    <div>
                        ...
                        <input id="amount" type="text" name = "amount" value="{{ $expenses->amount }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                ...
                <div class="grid mb-6 md:grid-cols-1">
                    ...
                    <textarea id="details" rows="4" name = "details"
                        ...
                        placeholder="Enter Details">{{ $expenses->details }}</textarea>
                </div>
                <div class="flex items-center justify-center w-full gap-4 max-sm:flex-col max-sm:p-0">
                    ...
                    <button
                        ...
                        onclick="window.location.href='/expenses/expensesList'">Cancel</button>
                </div>
            </div>
        </form>
    </div>
