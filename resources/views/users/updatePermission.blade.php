...
<div class="flex flex-col flex-grow">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <p class="text-sm font-medium text-gray-700 ms-1 md:ms-2">Update Permission</p>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="p-6">
        ...
        <form method="POST" action="{{ route('users.updatePermission', $permission->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    <div>
                        ...
                        <input id="permission" type="text" name="permission" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter permission" value="{{ $permission->permissions_name }}" required>
                    </div>
                </div>
                <div class="flex items-center justify-center w-full gap-4 max-sm:flex-col max-sm:p-0">
                    ...
                    <button type="button" class="px-6 py-3 text-white bg-red-600 rounded-lg max-sm:py-1 max-sm:px-3 max-sm:w-full" onclick="window.location.href='/users/permissionList'">Cancel</button>
                </div>
            </form>
