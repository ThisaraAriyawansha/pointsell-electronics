                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <p class="text-sm font-medium text-gray-700 ms-1 md:ms-2">Add New User</p>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            {{-- Validation Errors Summary --}}
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>                  
                              <!--custom combobox-->
                        <div class="md:col-span-2">
                        <label for="city" class="block mb-2 text-sm font-medium text-black">Role</label>
                ...
                <div id="message"></div> <!-- This will show success or error message -->
                ...
                <div class="flex items-center justify-center w-full gap-4 max-sm:flex-col max-sm:p-0">
                        ...
                        <button type="reset" class="px-6 py-3 text-white bg-black rounded-lg max-sm:py-1 max-sm:px-3 max-sm:w-full"
                        >Reset</button>
