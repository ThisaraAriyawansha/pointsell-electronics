@include('layouts.header')
    <div class="flex flex-col h-5/6 max-lg:h-fit">
        <!--breadcrumbs-->
        ...
        <div class="px-12 max-sm:px-6">
            <form>
                <div class="grid gap-6 py-6 md:grid-cols-5">
                    ...
                    <div>
                        <label for="customer-search" class="block mb-2 text-sm font-medium text-black">Customer Number</label>
                        <div class="w-full custom-select">
                ...
                <div class="grid md:grid-cols-1">
                    <button id="filter-btn" type="button"
                        class="py-3 px-6 bg-[#1b4f72] text-white rounded-lg place-self-end">Submit</button>
                </div>
            </form><br>
        </div>
        --}}
