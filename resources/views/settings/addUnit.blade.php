                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <p class="ms-1 text-sm font-medium text-gray-700 md:ms-2">Add New Unit</p>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="p-6">
            <div class="flex flex-grow flex-col border-2 h-full rounded-lg p-6">
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    <div>
                        <label for="unit_name" class="block mb-2 text-sm font-medium text-black ">Unit Name</label>
