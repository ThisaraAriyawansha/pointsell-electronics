...
(5, 'gggg', '2025-03-18 07:32:42', '2025-03-18 07:32:42');
...
(5, 'fff', '2025-03-18 07:32:38', '2025-03-18 07:32:38');
...
(6, 'aaa', '2025-03-18 07:32:32', '2025-03-18 07:32:32');
...
(44, '16911', 'aaa', 11, 1, 2, 2.00, 2.00, 2.00, 2, NULL, 15, 1, '2025-03-18 05:11:06', '2025-03-18 08:09:01'),
(45, '62575', 'aaa', 10, 2, 2, 2.00, 2.00, 2.00, 2, NULL, 14, 1, '2025-03-18 05:51:57', '2025-03-18 08:12:54'),
(46, '03841', 'aaaa', 10, 2, 2, 2.00, 4.00, 2.00, 2, 'default.png', 14, 1, '2025-03-18 07:28:24', '2025-03-18 07:29:46'),
...
--
-- Table structure for table `mobile_imeis`
--

CREATE TABLE `mobile_imeis` (
  `id` int(11) NOT NULL,
  `mobile_item_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `mobile_imeis`
--

INSERT INTO `mobile_imeis` (`id`, `mobile_item_id`, `imei_number`, `purchase_status_id`, `created_at`, `updated_at`) VALUES
(31, 28, '12345667788', 2, '2025-03-06 14:50:33', '2025-03-25 12:37:07'),
(32, 29, '12334545677', 2, '2025-03-18 07:32:57', '2025-03-18 07:33:32'),
(33, 30, '234455', 1, '2025-03-18 08:17:51', '2025-03-18 08:17:51');

-- --------------------------------------------------------

--
-- Table structure for table `mobile_items`
--
...
--
-- Dumping data for table `mobile_items`
--

INSERT INTO `mobile_items` (`id`, `name`, `brand_id`, `model_id`, `description`, `color_id`, `storage_id`, `ram_id`, `distributor_id`, `distributor_price`, `dealer_id`, `dealer_price`, `agent_id`, `agent_price`, `tax`, `mrp_price`, `purchase_price`, `image_path`, `status_id`, `created_at`, `updated_at`) VALUES
(28, 'abc', 7, 26, 'acdseff', 26, 12, 11, NULL, NULL, NULL, NULL, NULL, NULL, 10.00, 2000.00, NULL, NULL, 1, '2025-03-06 14:50:33', '2025-03-06 14:50:33'),
(29, 'ABCDE', 7, 26, 'abcde', 18, 12, 11, 6, 200.00, 5, 200.00, 5, 200.00, 1.00, 200.00, 200.00, NULL, 1, '2025-03-18 07:32:57', '2025-03-18 07:32:57'),
(30, 'aaa', 7, 26, 'aaa', 2, 12, 11, 6, 2.00, 5, 2.00, 5, 2.00, 1.00, 2.00, 2.00, NULL, 1, '2025-03-18 08:17:51', '2025-03-18 08:17:51');
...
CREATE TABLE `mobile_orders` (
  ...
  `mobile_imei_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
INSERT INTO `mobile_orders` (`id`, `invoice_number`, `mobile_imei_id`, `name`, `email`, `number`, `address`, `created_at`, `updated_at`) VALUES
(5, 'INV-WV4CBAWR0J', 32, 'abcde', 'abc@gmail.com', '123456', 'abcde', '2025-03-18 07:33:31', '2025-03-18 07:33:31'),
(6, 'INV-AHNUUEPMRU', 31, 'aa', 'cb@gmail', '222', 'ss', '2025-03-25 12:37:07', '2025-03-25 12:37:07');
...
(26, 'bcd', '2025-03-06 14:49:51', '2025-03-06 14:49:51');
...
(11, '4', '2025-03-06 14:50:17', '2025-03-06 14:50:17');
...
INSERT INTO `serial_numbers` (`id`, `serial_number`, `otherItem_id`, `purchase_status_id`, `created_at`, `updated_at`) VALUES
(1, '111111', 1, 1, '2025-03-25 05:17:44', '2025-03-26 11:40:32'),
(2, '22222', 1, 1, '2025-03-25 05:17:44', '2025-03-26 05:17:22'),
(3, '3333', 1, 1, '2025-03-25 05:17:44', '2025-03-26 04:50:21'),
(6, '11111111111111111111', 3, 1, '2025-03-25 05:35:38', '2025-03-26 11:40:38'),
(7, '4444444444444', 3, 1, '2025-03-25 05:35:38', '2025-03-26 11:40:43'),
(8, '5555555', 4, 1, '2025-03-25 06:00:26', '2025-03-26 04:50:40'),
(9, '666666', 4, 1, '2025-03-25 06:00:26', '2025-03-26 11:40:48'),
(10, '777777', 4, 1, '2025-03-25 06:00:26', '2025-03-26 11:40:54'),
(11, '77777777777', 4, 1, '2025-03-25 06:42:45', '2025-03-26 11:40:59'),
(12, '8888888', 4, 1, '2025-03-25 06:43:05', '2025-03-26 11:41:04');
...
(1, 'Login Page Image', 'Company Logo/1741065672_logo.png', '2025-01-19 23:54:24', '2025-03-04 05:21:12'),
...
(6, 'Company Name', 'Udarata Computers', '2025-01-19 23:59:00', '2025-03-04 05:21:39'),
(7, 'Header Color', '#010117', '2025-01-19 23:59:18', '2025-03-18 07:51:11'),
(8, 'Footer Color', '#010117', '2025-01-19 23:59:49', '2025-03-18 07:51:24'),
(9, 'Company Address', '229/4, Colombo Road,  Pilimathalawa', '2025-01-20 00:00:34', '2025-03-04 05:21:53'),
(10, 'Company Contact No', '0779876543', '2025-01-20 00:00:54', '2025-03-04 05:22:21'),
(11, 'Company Mobile No', '0779876543', '2025-01-20 00:00:54', '2025-03-04 05:22:29'),
(12, 'Company Web site URL', 'support@udaratacomputers.com', '2025-01-20 00:02:40', '2025-03-04 05:22:43'),
(13, 'Header Icon', 'Company Logo/1741065773_favicon.ico', NULL, '2025-03-04 05:22:53'),
...
(2, 'Udarata Computers', 'aaa', 'aa', '0779876543', 'Company Logo/1741065573_logo.png', '2024-12-30 04:17:19', '2025-03-04 05:19:56');
...
(1, 'ddddd', 'admin@gmail.com', '0761234567', '2024-11-28 15:41:41', '$2y$12$pFOIESa97xDPZdGUxl.DR.Q6gfFOgY4HFPEoI4Z6K2xonRvkjif6G', NULL, NULL, NULL, 'WmWyXbqiAhirSaPxiUoDEmY8rxBn2bwiXDdfhqg5bWWiP35eESIPrG7kXbtr', 1, 1, 'male', NULL, NULL, '2025-03-14 11:36:26'),
...
--
-- Indexes for table `mobile_imeis`
--
ALTER TABLE `mobile_imeis`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `imei_number` (`imei_number`),
  ADD KEY `mobile_item_id` (`mobile_item_id`),
  ADD KEY `purchase_status_id_fk` (`purchase_status_id`);

--
-- Indexes for table `mobile_items`
--
ALTER TABLE `mobile_items`
  ADD PRIMARY KEY (`id`),
  ...
  ADD KEY `mobile_item_ibfk_5` (`ram_id`),
  ADD KEY `mobile_item_ibfk_4` (`storage_id`),
  ADD KEY `mobile_item_ibfk_2` (`model_id`);
...
ALTER TABLE `mobile_orders`
  ...
  ADD KEY `mobile_ime_fk_order` (`mobile_imei_id`);
...
ALTER TABLE `serial_numbers`
  ...
  ADD KEY `otherItem_id` (`otherItem_id`),
  ADD KEY `purchase_status_id_fk_qwwew` (`purchase_status_id`);
...
--
-- AUTO_INCREMENT for table `mobile_imeis`
--
ALTER TABLE `mobile_imeis`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `mobile_items`
--
ALTER TABLE `mobile_items`
...
--
-- Constraints for table `mobile_imeis`
--
ALTER TABLE `mobile_imeis`
  ADD CONSTRAINT `mobile_imei_ibfk_1_gh` FOREIGN KEY (`mobile_item_id`) REFERENCES `mobile_items` (`id`),
  ADD CONSTRAINT `purchase_status_id_fk-HJ` FOREIGN KEY (`purchase_status_id`) REFERENCES `purchase_status` (`id`);

--
-- Constraints for table `mobile_items`
--
ALTER TABLE `mobile_items`
  ADD CONSTRAINT `mobile_item_ibfk_1s` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`),
  ADD CONSTRAINT `mobile_item_ibfk_2s` FOREIGN KEY (`model_id`) REFERENCES `modells` (`id`),
  ADD CONSTRAINT `mobile_item_ibfk_3s` FOREIGN KEY (`color_id`) REFERENCES `colors` (`id`),
  ADD CONSTRAINT `mobile_item_ibfk_4s` FOREIGN KEY (`storage_id`) REFERENCES `storages` (`id`),
  ADD CONSTRAINT `mobile_item_ibfk_5s` FOREIGN KEY (`ram_id`) REFERENCES `rams` (`id`),
  ADD CONSTRAINT `mobile_item_ibfk_6s` FOREIGN KEY (`distributor_id`) REFERENCES `distributors` (`id`),
  ADD CONSTRAINT `mobile_item_ibfk_7s` FOREIGN KEY (`dealer_id`) REFERENCES `dealers` (`id`),
  ADD CONSTRAINT `mobile_item_ibfk_8s` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`id`),
  ADD CONSTRAINT `satushgjh` FOREIGN KEY (`status_id`) REFERENCES `statuses` (`id`);

--
-- Constraints for table `mobile_orders`
--
ALTER TABLE `mobile_orders`
  ADD CONSTRAINT `mobile_ime_fk_order` FOREIGN KEY (`mobile_imei_id`) REFERENCES `mobile_imeis` (`id`);
...
--
ALTER TABLE `serial_numbers`
  ADD CONSTRAINT `purchase_status_id_fk_qwwew` FOREIGN KEY (`purchase_status_id`) REFERENCES `purchase_status` (`id`),
  ADD CONSTRAINT `serial_numbers_ibfk_1` FOREIGN KEY (`otherItem_id`) REFERENCES `other_item` (`id`) ON DELETE CASCADE;
